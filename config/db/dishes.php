...
return [
    ...
    // * Antipasti
    [
        'name' => 'C\'era uno scampo tra tuberi e radici',
    ...
    [
        'name' => 'Fagotelli "La Pergola"',
        'description' => 'Piatto cucinato dallo chef Stellato Heinz Beck',
        'ingredients' => 'fagotelli',
        'price' => 65,
    ...
    [
        'name' => 'Tortellini ripieni',
        'description' => 'Piatto cucinato dallo chef Stellato Heinz Beck',
        'ingredients' => 'cavolo nero, prosciutto d\'anatra e tartufo nero',
        'price' => 69,
    ...
    [
        'name' => 'Filetto di vitello su crudo di bieta',
        'description' => 'Piatto cucinato dallo chef Stellato Heinz Beck',
        'ingredients' => 'carne di vitello',
        'price' => 72,
    ...
    [
        ...
        'ingredients' => 'acqua',
        'price' => 1,
        'img_path' => 'https://media.istockphoto.com/id/185072125/it/foto/bottiglia-di-acqua-minerale-fittizio.jpg?s=612x612&w=0&k=20&c=0o6cCgZuGSbipIsqHNIv4uWEux5P6YWvOjWin-oh6Tg=',
        'restaurant_id' => 5,
        'category_id' => 7,
    ],
    ...
    [
        ...
        'ingredients' => 'acqua',
        'price' => 1.5,
        'img_path' => 'https://media.istockphoto.com/id/451992561/it/foto/versare-lacqua-in-vetro.jpg?s=612x612&w=0&k=20&c=C1cSgvlYd9cYsweQNe_bBNV9RaCAbER_DP752nFblDU=',
        'restaurant_id' => 5,
        'category_id' => 7,
    ],

    // ? 6: LA SUSHERIA DA GINO GINETTI  
    // * Antipasti
    [
    ...
    [
        'name' => 'Sashimi Sake',
        'description' => 'Filetto di salmone crudo',
        'ingredients' => 'salmone crudo',
        'price' => 6,
        'img_path' => 'https://media.istockphoto.com/id/910042608/it/foto/sgombro-crudo-e-salmone-crudo.jpg?s=612x612&w=0&k=20&c=EBC6-UK5VhaV6A_FS_swMotLvV_1m1R1juSJmf4jUVM=',
        'restaurant_id' => 6,
        'category_id' => 8,
    ],

    // ? 7: LA TAVERNA DI PAOLO DETTO DOMENICO
    // * Antipasti
    [
        'name' => 'Mozzarella fritta',
        'description' => 'Mozzarella fritta',
        'ingredients' => 'mozzarella',
        'price' => 13,
        'img_path' => 'https://media.istockphoto.com/id/149455608/it/foto/formaggio-fritto-punture.jpg?s=612x612&w=0&k=20&c=vI0HSMdfQo3LWo8WGadPVvp6Qmt9EemFOC7xuh4jRg4=',
        'restaurant_id' => 7,
        'category_id' => 1,
    ],
    ...
    [
        'name' => 'Paccheri con pesce spada',
        'description' => 'Trancio di pesce spada fresco tagliato a dadini con l\'aggiunta di pomodorini del Piennolo di nostra coltivazione',
        'ingredients' => 'pesce spada,pomodorini',
        'price' => 14,
        'img_path' => 'https://media.istockphoto.com/id/923824566/it/foto/paccheri-italiani-con-pesce-spada.jpg?s=612x612&w=0&k=20&c=aFBs1mlgc3WbCaft2-jkpigPaNt9Svau_3ziuKJJZlg=',
        'restaurant_id' => 7,
        'category_id' => 2,
    ],

    [
        'name' => 'Scialatielli alla nerana con gamberi',
        'description' => 'Zucchine e Gamberetti una poesia di sapori servita con scialatelli pasta tipica campana',
        'ingredients' => 'zucchine,gamberetti,pasta',
        'price' => 14,
        'img_path' => 'https://media.istockphoto.com/id/1269562933/it/foto/scialatielli-con-frutti-di-mare.jpg?s=612x612&w=0&k=20&c=2NlwonuTOKjBJ92ViXlJne0LqMUHyIG1leuazqFcV0Y=',
        'restaurant_id' => 7,
        'category_id' => 2,
    ],
    ...
    // * Secondo
    [
        'name' => 'Gamberi e calamari',
        'description' => 'Pesce fresco alla griglia servito su un letto di insalata',
        'ingredients' => 'pesce,insalata',
        'price' => 15,
        'img_path' => 'https://media.istockphoto.com/id/990301368/it/foto/avocado-fresco-insalata-di-gamberi-con-mix-verde-lattuga-pomodorini-erbe-aromatiche-e-olio.jpg?s=612x612&w=0&k=20&c=1GqJo6414VKlvYAtD0TqP81CJ7mxxJNRSjVd_x5wgf4=',
        'restaurant_id' => 7,
        'category_id' => 3,
    ],

    [
        'name' => 'Bistecca di scottona',
        'description' => 'Succulenta bistecca dai 600 ai 700 gr servita con controno a scelta',
        'ingredients' => 'bistecca',
        'price' => 30,
        'img_path' => 'https://media.istockphoto.com/id/500466008/it/foto/bistecca-di-manzo.jpg?s=612x612&w=0&k=20&c=5G7RzzfUMuK4ge5pnZ0B8N9qdNP_oTpVR7m7gxlHduQ=',
        'restaurant_id' => 7,
        'category_id' => 3,
    ],

    [
        'name' => 'Salsiccia e frarielli',
        'description' => 'Salsiccia di nostra produzione con frarielli di nostra coltivazione',
        'ingredients' => 'salsiccia,frarielli',
        'price' => 10,
        'img_path' => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3YjknSJ55Hf0vhzj8Z61zHxwK09PabMsaSg&usqp=CAU',
        'restaurant_id' => 7,
        'category_id' => 3,
    ],
    ...
    [
        ...
        'description' => 'Acqua in bottiglia',
        'ingredients' => 'acqua',
        'price' => 2.5,
        'img_path' => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEzZneIZOoIUZTNJfLq5-LLV7ZpS6BTeMRMw&usqp=CAU',
        'restaurant_id' => 7,
        'category_id' => 7,
    ],
    ...
    [
        ...
        'ingredients' => 'caffè',
        'price' => 1.5,
        'img_path' => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmTUS24d7hMn_ldcg2JVX4HV1GP5FgXd8VkA&usqp=CAU',
        'restaurant_id' => 7,
        'category_id' => 7,
    ],

    // ? 8: LA PIZZERIA DI ANIELLO
    // * Pizza
    [
    ...
    [
        'name' => 'Vegetariana con verdure miste',
        'description' => 'Pizza impastata personalmente da Riccardo Nestola',
    ...
    [
        ...
        'ingredients' => 'carne di maiale e verdure',
        'price' => 5,
        'img_path' => 'https://media.istockphoto.com/id/1190330112/it/foto/maiale-fritto-e-verdure-su-sfondo-bianco.jpg?s=612x612&w=0&k=20&c=Hr11EbD7I_8ndR8A8Z5R8may8jWUZ1C2ED3Lge9Zao4=',
        'restaurant_id' => 11,
        'category_id' => 1,
    ],
